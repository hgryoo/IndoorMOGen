...
public class ThoroughfareNumberElement implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            String theNumberOccurrence;
            theNumberOccurrence = this.getNumberOccurrence();
            strategy.appendField(locator, this, "numberOccurrence", buffer, theNumberOccurrence);
        }
        {
            String theCode;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final ThoroughfareNumberElement that = ((ThoroughfareNumberElement) object);
        {
            String lhsContent;
        ...
        {
            String lhsNumberOccurrence;
            lhsNumberOccurrence = this.getNumberOccurrence();
            String rhsNumberOccurrence;
            rhsNumberOccurrence = that.getNumberOccurrence();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "numberOccurrence", lhsNumberOccurrence), LocatorUtils.property(thatLocator, "numberOccurrence", rhsNumberOccurrence), lhsNumberOccurrence, rhsNumberOccurrence)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            String theNumberOccurrence;
            theNumberOccurrence = this.getNumberOccurrence();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "numberOccurrence", theNumberOccurrence), currentHashCode, theNumberOccurrence);
        }
        {
            String theCode;
            theCode = this.getCode();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof ThoroughfareNumberElement) {
            final ThoroughfareNumberElement copy = ((ThoroughfareNumberElement) draftCopy);
            ...
            if (this.isSetNumberOccurrence()) {
                String sourceNumberOccurrence;
                sourceNumberOccurrence = this.getNumberOccurrence();
                String copyNumberOccurrence = ((String) strategy.copy(LocatorUtils.property(locator, "numberOccurrence", sourceNumberOccurrence), sourceNumberOccurrence));
                copy.setNumberOccurrence(copyNumberOccurrence);
            } else {
                copy.numberOccurrence = null;
            }
            if (this.isSetCode()) {
                String sourceCode;
