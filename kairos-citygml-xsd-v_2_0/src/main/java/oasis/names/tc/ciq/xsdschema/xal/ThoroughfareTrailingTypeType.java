    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ThoroughfareTrailingTypeType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ThoroughfareTrailingTypeType that = ((ThoroughfareTrailingTypeType) object);
        {
            String lhsContent;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof ThoroughfareTrailingTypeType) {
            final ThoroughfareTrailingTypeType copy = ((ThoroughfareTrailingTypeType) draftCopy);
