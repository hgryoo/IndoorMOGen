    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ThoroughfarePreDirectionType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ThoroughfarePreDirectionType that = ((ThoroughfarePreDirectionType) object);
        {
            String lhsContent;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof ThoroughfarePreDirectionType) {
            final ThoroughfarePreDirectionType copy = ((ThoroughfarePreDirectionType) draftCopy);
