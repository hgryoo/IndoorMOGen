 ...
 * 				none.
 * 
 * <p>Java class for InteriorBridgeRoomPropertyType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="InteriorBridgeRoomPropertyType"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence minOccurs="0"&gt;
 *         &lt;element ref="{http://www.opengis.net/citygml/bridge/2.0}BridgeRoom"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "InteriorBridgeRoomPropertyType", propOrder = {
    "bridgeRoom"
})
public class InteriorBridgeRoomPropertyType
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{

    @XmlElement(name = "BridgeRoom")
    protected BridgeRoomType bridgeRoom;
     ...
     *     
     */
    public BridgeRoomType getBridgeRoom() {
        return bridgeRoom;
    }
     ...
     *     
     */
    public void setBridgeRoom(BridgeRoomType value) {
        this.bridgeRoom = value;
    }

    public boolean isSetBridgeRoom() {
        return (this.bridgeRoom!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            BridgeRoomType theBridgeRoom;
            theBridgeRoom = this.getBridgeRoom();
            strategy.appendField(locator, this, "bridgeRoom", buffer, theBridgeRoom);
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof InteriorBridgeRoomPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final InteriorBridgeRoomPropertyType that = ((InteriorBridgeRoomPropertyType) object);
        {
            BridgeRoomType lhsBridgeRoom;
            lhsBridgeRoom = this.getBridgeRoom();
            BridgeRoomType rhsBridgeRoom;
            rhsBridgeRoom = that.getBridgeRoom();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "bridgeRoom", lhsBridgeRoom), LocatorUtils.property(thatLocator, "bridgeRoom", rhsBridgeRoom), lhsBridgeRoom, rhsBridgeRoom)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            BridgeRoomType theBridgeRoom;
            theBridgeRoom = this.getBridgeRoom();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "bridgeRoom", theBridgeRoom), currentHashCode, theBridgeRoom);
        }
        {
            String theRemoteSchema;
            theRemoteSchema = this.getRemoteSchema();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof InteriorBridgeRoomPropertyType) {
            final InteriorBridgeRoomPropertyType copy = ((InteriorBridgeRoomPropertyType) draftCopy);
            if (this.isSetBridgeRoom()) {
                BridgeRoomType sourceBridgeRoom;
                sourceBridgeRoom = this.getBridgeRoom();
                BridgeRoomType copyBridgeRoom = ((BridgeRoomType) strategy.copy(LocatorUtils.property(locator, "bridgeRoom", sourceBridgeRoom), sourceBridgeRoom));
                copy.setBridgeRoom(copyBridgeRoom);
            } else {
                copy.bridgeRoom = null;
            }
