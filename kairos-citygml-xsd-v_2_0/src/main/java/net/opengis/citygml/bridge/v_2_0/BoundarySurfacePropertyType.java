 ...
 *         &lt;element ref="{http://www.opengis.net/citygml/bridge/2.0}_BoundarySurface"/&gt;
 *       &lt;/sequence&gt;
    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    @XmlElementRef(name = "_BoundarySurface", namespace = "http://www.opengis.net/citygml/bridge/2.0", type = JAXBElement.class, required = false)
    protected JAXBElement<? extends AbstractBoundarySurfaceType> boundarySurface;
     ...
     *     
     */
    public JAXBElement<? extends AbstractBoundarySurfaceType> getBoundarySurface() {
     ...
     *     
     */
    public void setBoundarySurface(JAXBElement<? extends AbstractBoundarySurfaceType> value) {
        this.boundarySurface = value;
    }

    public boolean isSetBoundarySurface() {
        return (this.boundarySurface!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractBoundarySurfaceType> theBoundarySurface;
            theBoundarySurface = this.getBoundarySurface();
            strategy.appendField(locator, this, "boundarySurface", buffer, theBoundarySurface);
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof BoundarySurfacePropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final BoundarySurfacePropertyType that = ((BoundarySurfacePropertyType) object);
        {
            JAXBElement<? extends AbstractBoundarySurfaceType> lhsBoundarySurface;
            lhsBoundarySurface = this.getBoundarySurface();
            JAXBElement<? extends AbstractBoundarySurfaceType> rhsBoundarySurface;
            rhsBoundarySurface = that.getBoundarySurface();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "boundarySurface", lhsBoundarySurface), LocatorUtils.property(thatLocator, "boundarySurface", rhsBoundarySurface), lhsBoundarySurface, rhsBoundarySurface)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractBoundarySurfaceType> theBoundarySurface;
            theBoundarySurface = this.getBoundarySurface();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "boundarySurface", theBoundarySurface), currentHashCode, theBoundarySurface);
        }
        {
            String theRemoteSchema;
            theRemoteSchema = this.getRemoteSchema();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof BoundarySurfacePropertyType) {
            final BoundarySurfacePropertyType copy = ((BoundarySurfacePropertyType) draftCopy);
            if (this.isSetBoundarySurface()) {
                JAXBElement<? extends AbstractBoundarySurfaceType> sourceBoundarySurface;
                sourceBoundarySurface = this.getBoundarySurface();
                @SuppressWarnings("unchecked")
                JAXBElement<? extends AbstractBoundarySurfaceType> copyBoundarySurface = ((JAXBElement<? extends AbstractBoundarySurfaceType> ) strategy.copy(LocatorUtils.property(locator, "boundarySurface", sourceBoundarySurface), sourceBoundarySurface));
                copy.setBoundarySurface(copyBoundarySurface);
            } else {
                copy.boundarySurface = null;
            }
