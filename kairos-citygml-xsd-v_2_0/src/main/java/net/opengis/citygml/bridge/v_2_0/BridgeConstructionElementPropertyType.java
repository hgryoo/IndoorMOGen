 ...
 * 
 * <p>Java class for BridgeConstructionElementPropertyType complex type.
 * 
 ...
 *         &lt;element ref="{http://www.opengis.net/citygml/bridge/2.0}BridgeConstructionElement"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "BridgeConstructionElementPropertyType", propOrder = {
    "bridgeConstructionElement"
})
public class BridgeConstructionElementPropertyType
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{

    @XmlElement(name = "BridgeConstructionElement")
    protected BridgeConstructionElementType bridgeConstructionElement;
     ...
     * @return
     *     possible object is
     *     {@link BridgeConstructionElementType }
     *     
     */
    public BridgeConstructionElementType getBridgeConstructionElement() {
     ...
     *     
     */
    public void setBridgeConstructionElement(BridgeConstructionElementType value) {
        this.bridgeConstructionElement = value;
    }

    public boolean isSetBridgeConstructionElement() {
        return (this.bridgeConstructionElement!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            BridgeConstructionElementType theBridgeConstructionElement;
            theBridgeConstructionElement = this.getBridgeConstructionElement();
            strategy.appendField(locator, this, "bridgeConstructionElement", buffer, theBridgeConstructionElement);
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof BridgeConstructionElementPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final BridgeConstructionElementPropertyType that = ((BridgeConstructionElementPropertyType) object);
        {
            BridgeConstructionElementType lhsBridgeConstructionElement;
            lhsBridgeConstructionElement = this.getBridgeConstructionElement();
            BridgeConstructionElementType rhsBridgeConstructionElement;
            rhsBridgeConstructionElement = that.getBridgeConstructionElement();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "bridgeConstructionElement", lhsBridgeConstructionElement), LocatorUtils.property(thatLocator, "bridgeConstructionElement", rhsBridgeConstructionElement), lhsBridgeConstructionElement, rhsBridgeConstructionElement)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            BridgeConstructionElementType theBridgeConstructionElement;
            theBridgeConstructionElement = this.getBridgeConstructionElement();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "bridgeConstructionElement", theBridgeConstructionElement), currentHashCode, theBridgeConstructionElement);
        }
        {
            String theRemoteSchema;
            theRemoteSchema = this.getRemoteSchema();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof BridgeConstructionElementPropertyType) {
            final BridgeConstructionElementPropertyType copy = ((BridgeConstructionElementPropertyType) draftCopy);
            if (this.isSetBridgeConstructionElement()) {
                BridgeConstructionElementType sourceBridgeConstructionElement;
                sourceBridgeConstructionElement = this.getBridgeConstructionElement();
                BridgeConstructionElementType copyBridgeConstructionElement = ((BridgeConstructionElementType) strategy.copy(LocatorUtils.property(locator, "bridgeConstructionElement", sourceBridgeConstructionElement), sourceBridgeConstructionElement));
                copy.setBridgeConstructionElement(copyBridgeConstructionElement);
            } else {
                copy.bridgeConstructionElement = null;
            }
