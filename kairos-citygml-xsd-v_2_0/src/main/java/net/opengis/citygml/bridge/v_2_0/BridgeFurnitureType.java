 ...
 * 			
 * 
 * <p>Java class for BridgeFurnitureType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    @XmlElement(name = "_GenericApplicationPropertyOfBridgeFurniture")
    protected List<Object> genericApplicationPropertyOfBridgeFurniture;
     ...
     * For example, to add a new item, do as follows:
     * <pre>
     *    getGenericApplicationPropertyOfBridgeFurniture().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getGenericApplicationPropertyOfBridgeFurniture() {
        if (genericApplicationPropertyOfBridgeFurniture == null) {
            genericApplicationPropertyOfBridgeFurniture = new ArrayList<Object>();
        }
        return this.genericApplicationPropertyOfBridgeFurniture;
    }

    public boolean isSetGenericApplicationPropertyOfBridgeFurniture() {
        return ((this.genericApplicationPropertyOfBridgeFurniture!= null)&&(!this.genericApplicationPropertyOfBridgeFurniture.isEmpty()));
    }

    public void unsetGenericApplicationPropertyOfBridgeFurniture() {
        this.genericApplicationPropertyOfBridgeFurniture = null;
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            List<Object> theGenericApplicationPropertyOfBridgeFurniture;
            theGenericApplicationPropertyOfBridgeFurniture = (this.isSetGenericApplicationPropertyOfBridgeFurniture()?this.getGenericApplicationPropertyOfBridgeFurniture():null);
            strategy.appendField(locator, this, "genericApplicationPropertyOfBridgeFurniture", buffer, theGenericApplicationPropertyOfBridgeFurniture);
        }
        return buffer;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof BridgeFurnitureType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final BridgeFurnitureType that = ((BridgeFurnitureType) object);
        {
            CodeType lhsClazz;
        ...
        {
            List<Object> lhsGenericApplicationPropertyOfBridgeFurniture;
            lhsGenericApplicationPropertyOfBridgeFurniture = (this.isSetGenericApplicationPropertyOfBridgeFurniture()?this.getGenericApplicationPropertyOfBridgeFurniture():null);
            List<Object> rhsGenericApplicationPropertyOfBridgeFurniture;
            rhsGenericApplicationPropertyOfBridgeFurniture = (that.isSetGenericApplicationPropertyOfBridgeFurniture()?that.getGenericApplicationPropertyOfBridgeFurniture():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "genericApplicationPropertyOfBridgeFurniture", lhsGenericApplicationPropertyOfBridgeFurniture), LocatorUtils.property(thatLocator, "genericApplicationPropertyOfBridgeFurniture", rhsGenericApplicationPropertyOfBridgeFurniture), lhsGenericApplicationPropertyOfBridgeFurniture, rhsGenericApplicationPropertyOfBridgeFurniture)) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            List<Object> theGenericApplicationPropertyOfBridgeFurniture;
            theGenericApplicationPropertyOfBridgeFurniture = (this.isSetGenericApplicationPropertyOfBridgeFurniture()?this.getGenericApplicationPropertyOfBridgeFurniture():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "genericApplicationPropertyOfBridgeFurniture", theGenericApplicationPropertyOfBridgeFurniture), currentHashCode, theGenericApplicationPropertyOfBridgeFurniture);
        }
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof BridgeFurnitureType) {
            final BridgeFurnitureType copy = ((BridgeFurnitureType) draftCopy);
            if (this.isSetClazz()) {
            ...
            if (this.isSetGenericApplicationPropertyOfBridgeFurniture()) {
                List<Object> sourceGenericApplicationPropertyOfBridgeFurniture;
                sourceGenericApplicationPropertyOfBridgeFurniture = (this.isSetGenericApplicationPropertyOfBridgeFurniture()?this.getGenericApplicationPropertyOfBridgeFurniture():null);
                @SuppressWarnings("unchecked")
                List<Object> copyGenericApplicationPropertyOfBridgeFurniture = ((List<Object> ) strategy.copy(LocatorUtils.property(locator, "genericApplicationPropertyOfBridgeFurniture", sourceGenericApplicationPropertyOfBridgeFurniture), sourceGenericApplicationPropertyOfBridgeFurniture));
                copy.unsetGenericApplicationPropertyOfBridgeFurniture();
                if (copyGenericApplicationPropertyOfBridgeFurniture!= null) {
                    List<Object> uniqueGenericApplicationPropertyOfBridgeFurniturel = copy.getGenericApplicationPropertyOfBridgeFurniture();
                    uniqueGenericApplicationPropertyOfBridgeFurniturel.addAll(copyGenericApplicationPropertyOfBridgeFurniture);
                }
            } else {
                copy.unsetGenericApplicationPropertyOfBridgeFurniture();
            }
