 ...
 * 				none.
 * 
 * <p>Java class for BridgePartPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    /**
     * Gets the value of the bridgePart property.
     * 
     * @return
     *     possible object is
     *     {@link BridgePartType }
    ...
    /**
     * Sets the value of the bridgePart property.
     * 
     * @param value
     *     allowed object is
     *     {@link BridgePartType }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            BridgePartType theBridgePart;
            theBridgePart = this.getBridgePart();
            strategy.appendField(locator, this, "bridgePart", buffer, theBridgePart);
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof BridgePartPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final BridgePartPropertyType that = ((BridgePartPropertyType) object);
        {
            BridgePartType lhsBridgePart;
            lhsBridgePart = this.getBridgePart();
            BridgePartType rhsBridgePart;
            rhsBridgePart = that.getBridgePart();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "bridgePart", lhsBridgePart), LocatorUtils.property(thatLocator, "bridgePart", rhsBridgePart), lhsBridgePart, rhsBridgePart)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            BridgePartType theBridgePart;
            theBridgePart = this.getBridgePart();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "bridgePart", theBridgePart), currentHashCode, theBridgePart);
        }
        {
            String theRemoteSchema;
            theRemoteSchema = this.getRemoteSchema();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof BridgePartPropertyType) {
            final BridgePartPropertyType copy = ((BridgePartPropertyType) draftCopy);
            if (this.isSetBridgePart()) {
                BridgePartType sourceBridgePart;
                sourceBridgePart = this.getBridgePart();
                BridgePartType copyBridgePart = ((BridgePartType) strategy.copy(LocatorUtils.property(locator, "bridgePart", sourceBridgePart), sourceBridgePart));
                copy.setBridgePart(copyBridgePart);
            } else {
                copy.bridgePart = null;
            }
