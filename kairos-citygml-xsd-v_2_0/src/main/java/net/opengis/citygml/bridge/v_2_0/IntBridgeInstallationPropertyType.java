 ...
 * 
 * <p>Java class for IntBridgeInstallationPropertyType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="IntBridgeInstallationPropertyType"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence minOccurs="0"&gt;
 *         &lt;element ref="{http://www.opengis.net/citygml/bridge/2.0}IntBridgeInstallation"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "IntBridgeInstallationPropertyType", propOrder = {
    "intBridgeInstallation"
})
public class IntBridgeInstallationPropertyType
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{

    @XmlElement(name = "IntBridgeInstallation")
    protected IntBridgeInstallationType intBridgeInstallation;
     ...
     * @return
     *     possible object is
     *     {@link IntBridgeInstallationType }
     *     
     */
    public IntBridgeInstallationType getIntBridgeInstallation() {
     ...
     *     
     */
    public void setIntBridgeInstallation(IntBridgeInstallationType value) {
        this.intBridgeInstallation = value;
    }

    public boolean isSetIntBridgeInstallation() {
        return (this.intBridgeInstallation!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            IntBridgeInstallationType theIntBridgeInstallation;
            theIntBridgeInstallation = this.getIntBridgeInstallation();
            strategy.appendField(locator, this, "intBridgeInstallation", buffer, theIntBridgeInstallation);
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof IntBridgeInstallationPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final IntBridgeInstallationPropertyType that = ((IntBridgeInstallationPropertyType) object);
        {
            IntBridgeInstallationType lhsIntBridgeInstallation;
            lhsIntBridgeInstallation = this.getIntBridgeInstallation();
            IntBridgeInstallationType rhsIntBridgeInstallation;
            rhsIntBridgeInstallation = that.getIntBridgeInstallation();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "intBridgeInstallation", lhsIntBridgeInstallation), LocatorUtils.property(thatLocator, "intBridgeInstallation", rhsIntBridgeInstallation), lhsIntBridgeInstallation, rhsIntBridgeInstallation)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            IntBridgeInstallationType theIntBridgeInstallation;
            theIntBridgeInstallation = this.getIntBridgeInstallation();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "intBridgeInstallation", theIntBridgeInstallation), currentHashCode, theIntBridgeInstallation);
        }
        {
            String theRemoteSchema;
            theRemoteSchema = this.getRemoteSchema();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof IntBridgeInstallationPropertyType) {
            final IntBridgeInstallationPropertyType copy = ((IntBridgeInstallationPropertyType) draftCopy);
            if (this.isSetIntBridgeInstallation()) {
                IntBridgeInstallationType sourceIntBridgeInstallation;
                sourceIntBridgeInstallation = this.getIntBridgeInstallation();
                IntBridgeInstallationType copyIntBridgeInstallation = ((IntBridgeInstallationType) strategy.copy(LocatorUtils.property(locator, "intBridgeInstallation", sourceIntBridgeInstallation), sourceIntBridgeInstallation));
                copy.setIntBridgeInstallation(copyIntBridgeInstallation);
            } else {
                copy.intBridgeInstallation = null;
            }
