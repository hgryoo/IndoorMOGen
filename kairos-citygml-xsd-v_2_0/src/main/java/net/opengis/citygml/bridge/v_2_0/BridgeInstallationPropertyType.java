 ...
 * 
 * <p>Java class for BridgeInstallationPropertyType complex type.
 * 
 ...
 *         &lt;element ref="{http://www.opengis.net/citygml/bridge/2.0}BridgeInstallation"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "BridgeInstallationPropertyType", propOrder = {
    "bridgeInstallation"
})
public class BridgeInstallationPropertyType
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{

    @XmlElement(name = "BridgeInstallation")
    protected BridgeInstallationType bridgeInstallation;
     ...
     * @return
     *     possible object is
     *     {@link BridgeInstallationType }
     *     
     */
    public BridgeInstallationType getBridgeInstallation() {
     ...
     *     
     */
    public void setBridgeInstallation(BridgeInstallationType value) {
        this.bridgeInstallation = value;
    }

    public boolean isSetBridgeInstallation() {
        return (this.bridgeInstallation!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            BridgeInstallationType theBridgeInstallation;
            theBridgeInstallation = this.getBridgeInstallation();
            strategy.appendField(locator, this, "bridgeInstallation", buffer, theBridgeInstallation);
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof BridgeInstallationPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final BridgeInstallationPropertyType that = ((BridgeInstallationPropertyType) object);
        {
            BridgeInstallationType lhsBridgeInstallation;
            lhsBridgeInstallation = this.getBridgeInstallation();
            BridgeInstallationType rhsBridgeInstallation;
            rhsBridgeInstallation = that.getBridgeInstallation();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "bridgeInstallation", lhsBridgeInstallation), LocatorUtils.property(thatLocator, "bridgeInstallation", rhsBridgeInstallation), lhsBridgeInstallation, rhsBridgeInstallation)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            BridgeInstallationType theBridgeInstallation;
            theBridgeInstallation = this.getBridgeInstallation();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "bridgeInstallation", theBridgeInstallation), currentHashCode, theBridgeInstallation);
        }
        {
            String theRemoteSchema;
            theRemoteSchema = this.getRemoteSchema();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof BridgeInstallationPropertyType) {
            final BridgeInstallationPropertyType copy = ((BridgeInstallationPropertyType) draftCopy);
            if (this.isSetBridgeInstallation()) {
                BridgeInstallationType sourceBridgeInstallation;
                sourceBridgeInstallation = this.getBridgeInstallation();
                BridgeInstallationType copyBridgeInstallation = ((BridgeInstallationType) strategy.copy(LocatorUtils.property(locator, "bridgeInstallation", sourceBridgeInstallation), sourceBridgeInstallation));
                copy.setBridgeInstallation(copyBridgeInstallation);
            } else {
                copy.bridgeInstallation = null;
            }
