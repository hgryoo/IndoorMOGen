 ...
 * generated in the net.opengis.citygml.transportation.v_2_0 package. 
...
public class ObjectFactory {
    ...
    private final static QName _TransportationObject_QNAME = new QName("http://www.opengis.net/citygml/transportation/2.0", "_TransportationObject");
    private final static QName _GenericApplicationPropertyOfTransportationObject_QNAME = new QName("http://www.opengis.net/citygml/transportation/2.0", "_GenericApplicationPropertyOfTransportationObject");
    ...
    private final static QName _GenericApplicationPropertyOfTransportationComplex_QNAME = new QName("http://www.opengis.net/citygml/transportation/2.0", "_GenericApplicationPropertyOfTransportationComplex");
    private final static QName _TrafficArea_QNAME = new QName("http://www.opengis.net/citygml/transportation/2.0", "TrafficArea");
    private final static QName _GenericApplicationPropertyOfTrafficArea_QNAME = new QName("http://www.opengis.net/citygml/transportation/2.0", "_GenericApplicationPropertyOfTrafficArea");
    ...
    private final static QName _GenericApplicationPropertyOfAuxiliaryTrafficArea_QNAME = new QName("http://www.opengis.net/citygml/transportation/2.0", "_GenericApplicationPropertyOfAuxiliaryTrafficArea");
    private final static QName _Track_QNAME = new QName("http://www.opengis.net/citygml/transportation/2.0", "Track");
    private final static QName _GenericApplicationPropertyOfTrack_QNAME = new QName("http://www.opengis.net/citygml/transportation/2.0", "_GenericApplicationPropertyOfTrack");
    private final static QName _Road_QNAME = new QName("http://www.opengis.net/citygml/transportation/2.0", "Road");
    private final static QName _GenericApplicationPropertyOfRoad_QNAME = new QName("http://www.opengis.net/citygml/transportation/2.0", "_GenericApplicationPropertyOfRoad");
    private final static QName _Railway_QNAME = new QName("http://www.opengis.net/citygml/transportation/2.0", "Railway");
    private final static QName _GenericApplicationPropertyOfRailway_QNAME = new QName("http://www.opengis.net/citygml/transportation/2.0", "_GenericApplicationPropertyOfRailway");
    private final static QName _Square_QNAME = new QName("http://www.opengis.net/citygml/transportation/2.0", "Square");
    private final static QName _GenericApplicationPropertyOfSquare_QNAME = new QName("http://www.opengis.net/citygml/transportation/2.0", "_GenericApplicationPropertyOfSquare");
