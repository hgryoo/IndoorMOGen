 ...
 *         &lt;element ref="{http://www.opengis.net/citygml/transportation/2.0}AuxiliaryTrafficArea"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "AuxiliaryTrafficAreaPropertyType", propOrder = {
    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    @XmlElement(name = "AuxiliaryTrafficArea")
    protected AuxiliaryTrafficAreaType auxiliaryTrafficArea;
     ...
     *     
     */
    public void setAuxiliaryTrafficArea(AuxiliaryTrafficAreaType value) {
        this.auxiliaryTrafficArea = value;
    }

    public boolean isSetAuxiliaryTrafficArea() {
        return (this.auxiliaryTrafficArea!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            AuxiliaryTrafficAreaType theAuxiliaryTrafficArea;
            theAuxiliaryTrafficArea = this.getAuxiliaryTrafficArea();
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof AuxiliaryTrafficAreaPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final AuxiliaryTrafficAreaPropertyType that = ((AuxiliaryTrafficAreaPropertyType) object);
        {
            AuxiliaryTrafficAreaType lhsAuxiliaryTrafficArea;
            lhsAuxiliaryTrafficArea = this.getAuxiliaryTrafficArea();
            AuxiliaryTrafficAreaType rhsAuxiliaryTrafficArea;
            rhsAuxiliaryTrafficArea = that.getAuxiliaryTrafficArea();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof AuxiliaryTrafficAreaPropertyType) {
            final AuxiliaryTrafficAreaPropertyType copy = ((AuxiliaryTrafficAreaPropertyType) draftCopy);
            if (this.isSetAuxiliaryTrafficArea()) {
                AuxiliaryTrafficAreaType sourceAuxiliaryTrafficArea;
                sourceAuxiliaryTrafficArea = this.getAuxiliaryTrafficArea();
                AuxiliaryTrafficAreaType copyAuxiliaryTrafficArea = ((AuxiliaryTrafficAreaType) strategy.copy(LocatorUtils.property(locator, "auxiliaryTrafficArea", sourceAuxiliaryTrafficArea), sourceAuxiliaryTrafficArea));
                copy.setAuxiliaryTrafficArea(copyAuxiliaryTrafficArea);
            } else {
                copy.auxiliaryTrafficArea = null;
            }
