 ...
 *         &lt;element ref="{http://www.opengis.net/citygml/transportation/2.0}TrafficArea"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "TrafficAreaPropertyType", propOrder = {
    "trafficArea"
})
    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
     ...
     *     
     */
    public void setTrafficArea(TrafficAreaType value) {
        this.trafficArea = value;
    }

    public boolean isSetTrafficArea() {
        return (this.trafficArea!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            TrafficAreaType theTrafficArea;
            theTrafficArea = this.getTrafficArea();
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof TrafficAreaPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final TrafficAreaPropertyType that = ((TrafficAreaPropertyType) object);
        {
            TrafficAreaType lhsTrafficArea;
            lhsTrafficArea = this.getTrafficArea();
            TrafficAreaType rhsTrafficArea;
            rhsTrafficArea = that.getTrafficArea();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof TrafficAreaPropertyType) {
            final TrafficAreaPropertyType copy = ((TrafficAreaPropertyType) draftCopy);
            if (this.isSetTrafficArea()) {
                TrafficAreaType sourceTrafficArea;
                sourceTrafficArea = this.getTrafficArea();
                TrafficAreaType copyTrafficArea = ((TrafficAreaType) strategy.copy(LocatorUtils.property(locator, "trafficArea", sourceTrafficArea), sourceTrafficArea));
                copy.setTrafficArea(copyTrafficArea);
            } else {
                copy.trafficArea = null;
            }
