 ...
 * 
 * <p>Java class for BoundedByWaterSurfacePropertyType complex type.
 * 
...
@XmlType(name = "BoundedByWaterSurfacePropertyType", propOrder = {
    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    @XmlElementRef(name = "_WaterBoundarySurface", namespace = "http://www.opengis.net/citygml/waterbody/2.0", type = JAXBElement.class, required = false)
    protected JAXBElement<? extends AbstractWaterBoundarySurfaceType> waterBoundarySurface;
     ...
     *     
     */
    public JAXBElement<? extends AbstractWaterBoundarySurfaceType> getWaterBoundarySurface() {
     ...
     *     
     */
    public void setWaterBoundarySurface(JAXBElement<? extends AbstractWaterBoundarySurfaceType> value) {
        this.waterBoundarySurface = value;
    }

    public boolean isSetWaterBoundarySurface() {
        return (this.waterBoundarySurface!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractWaterBoundarySurfaceType> theWaterBoundarySurface;
            theWaterBoundarySurface = this.getWaterBoundarySurface();
            strategy.appendField(locator, this, "waterBoundarySurface", buffer, theWaterBoundarySurface);
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof BoundedByWaterSurfacePropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final BoundedByWaterSurfacePropertyType that = ((BoundedByWaterSurfacePropertyType) object);
        {
            JAXBElement<? extends AbstractWaterBoundarySurfaceType> lhsWaterBoundarySurface;
            lhsWaterBoundarySurface = this.getWaterBoundarySurface();
            JAXBElement<? extends AbstractWaterBoundarySurfaceType> rhsWaterBoundarySurface;
            rhsWaterBoundarySurface = that.getWaterBoundarySurface();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "waterBoundarySurface", lhsWaterBoundarySurface), LocatorUtils.property(thatLocator, "waterBoundarySurface", rhsWaterBoundarySurface), lhsWaterBoundarySurface, rhsWaterBoundarySurface)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractWaterBoundarySurfaceType> theWaterBoundarySurface;
            theWaterBoundarySurface = this.getWaterBoundarySurface();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "waterBoundarySurface", theWaterBoundarySurface), currentHashCode, theWaterBoundarySurface);
        }
        {
            String theRemoteSchema;
            theRemoteSchema = this.getRemoteSchema();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof BoundedByWaterSurfacePropertyType) {
            final BoundedByWaterSurfacePropertyType copy = ((BoundedByWaterSurfacePropertyType) draftCopy);
            if (this.isSetWaterBoundarySurface()) {
                JAXBElement<? extends AbstractWaterBoundarySurfaceType> sourceWaterBoundarySurface;
                sourceWaterBoundarySurface = this.getWaterBoundarySurface();
                @SuppressWarnings("unchecked")
                JAXBElement<? extends AbstractWaterBoundarySurfaceType> copyWaterBoundarySurface = ((JAXBElement<? extends AbstractWaterBoundarySurfaceType> ) strategy.copy(LocatorUtils.property(locator, "waterBoundarySurface", sourceWaterBoundarySurface), sourceWaterBoundarySurface));
                copy.setWaterBoundarySurface(copyWaterBoundarySurface);
            } else {
                copy.waterBoundarySurface = null;
            }
