    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    protected String cityObjectGroupMemberRole;
    ...
    /**
     * Gets the value of the cityObjectGroupMemberRole property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getCityObjectGroupMemberRole() {
        return cityObjectGroupMemberRole;
    }

    /**
     * Sets the value of the cityObjectGroupMemberRole property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setCityObjectGroupMemberRole(String value) {
        this.cityObjectGroupMemberRole = value;
    }

    public boolean isSetCityObjectGroupMemberRole() {
        return (this.cityObjectGroupMemberRole!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            String theCityObjectGroupMemberRole;
            theCityObjectGroupMemberRole = this.getCityObjectGroupMemberRole();
            strategy.appendField(locator, this, "cityObjectGroupMemberRole", buffer, theCityObjectGroupMemberRole);
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CityObjectGroupMemberType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final CityObjectGroupMemberType that = ((CityObjectGroupMemberType) object);
        {
        ...
        {
            String lhsCityObjectGroupMemberRole;
            lhsCityObjectGroupMemberRole = this.getCityObjectGroupMemberRole();
            String rhsCityObjectGroupMemberRole;
            rhsCityObjectGroupMemberRole = that.getCityObjectGroupMemberRole();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "cityObjectGroupMemberRole", lhsCityObjectGroupMemberRole), LocatorUtils.property(thatLocator, "cityObjectGroupMemberRole", rhsCityObjectGroupMemberRole), lhsCityObjectGroupMemberRole, rhsCityObjectGroupMemberRole)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            String theCityObjectGroupMemberRole;
            theCityObjectGroupMemberRole = this.getCityObjectGroupMemberRole();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "cityObjectGroupMemberRole", theCityObjectGroupMemberRole), currentHashCode, theCityObjectGroupMemberRole);
        }
        {
            String theRemoteSchema;
            theRemoteSchema = this.getRemoteSchema();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof CityObjectGroupMemberType) {
            final CityObjectGroupMemberType copy = ((CityObjectGroupMemberType) draftCopy);
            ...
            if (this.isSetCityObjectGroupMemberRole()) {
                String sourceCityObjectGroupMemberRole;
                sourceCityObjectGroupMemberRole = this.getCityObjectGroupMemberRole();
                String copyCityObjectGroupMemberRole = ((String) strategy.copy(LocatorUtils.property(locator, "cityObjectGroupMemberRole", sourceCityObjectGroupMemberRole), sourceCityObjectGroupMemberRole));
                copy.setCityObjectGroupMemberRole(copyCityObjectGroupMemberRole);
            } else {
                copy.cityObjectGroupMemberRole = null;
            }
