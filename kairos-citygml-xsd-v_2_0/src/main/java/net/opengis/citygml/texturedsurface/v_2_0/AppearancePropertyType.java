    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    @XmlElementRef(name = "_Appearance", namespace = "http://www.opengis.net/citygml/texturedsurface/2.0", type = JAXBElement.class, required = false)
    protected JAXBElement<? extends AbstractAppearanceType> appearance;
     ...
     *     
     */
    public JAXBElement<? extends AbstractAppearanceType> getAppearance() {
        return appearance;
    }
     ...
     *     
     */
    public void setAppearance(JAXBElement<? extends AbstractAppearanceType> value) {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractAppearanceType> theAppearance;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof AppearancePropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final AppearancePropertyType that = ((AppearancePropertyType) object);
        {
            JAXBElement<? extends AbstractAppearanceType> lhsAppearance;
            lhsAppearance = this.getAppearance();
            JAXBElement<? extends AbstractAppearanceType> rhsAppearance;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof AppearancePropertyType) {
            final AppearancePropertyType copy = ((AppearancePropertyType) draftCopy);
            if (this.isSetAppearance()) {
                JAXBElement<? extends AbstractAppearanceType> sourceAppearance;
                sourceAppearance = this.getAppearance();
                @SuppressWarnings("unchecked")
                JAXBElement<? extends AbstractAppearanceType> copyAppearance = ((JAXBElement<? extends AbstractAppearanceType> ) strategy.copy(LocatorUtils.property(locator, "appearance", sourceAppearance), sourceAppearance));
