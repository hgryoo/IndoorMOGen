 ...
 *         &lt;element ref="{http://www.opengis.net/citygml/building/2.0}Room"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "InteriorRoomPropertyType", propOrder = {
    "room"
})
    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof InteriorRoomPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final InteriorRoomPropertyType that = ((InteriorRoomPropertyType) object);
        {
            RoomType lhsRoom;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof InteriorRoomPropertyType) {
            final InteriorRoomPropertyType copy = ((InteriorRoomPropertyType) draftCopy);
            if (this.isSetRoom()) {
                RoomType sourceRoom;
                sourceRoom = this.getRoom();
                RoomType copyRoom = ((RoomType) strategy.copy(LocatorUtils.property(locator, "room", sourceRoom), sourceRoom));
                copy.setRoom(copyRoom);
            } else {
                copy.room = null;
            }
