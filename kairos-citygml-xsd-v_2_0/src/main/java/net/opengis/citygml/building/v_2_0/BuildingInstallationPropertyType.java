 ...
 *         &lt;element ref="{http://www.opengis.net/citygml/building/2.0}BuildingInstallation"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "BuildingInstallationPropertyType", propOrder = {
    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    @XmlElement(name = "BuildingInstallation")
     ...
     *     
     */
    public void setBuildingInstallation(BuildingInstallationType value) {
        this.buildingInstallation = value;
    }

    public boolean isSetBuildingInstallation() {
        return (this.buildingInstallation!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            BuildingInstallationType theBuildingInstallation;
            theBuildingInstallation = this.getBuildingInstallation();
            strategy.appendField(locator, this, "buildingInstallation", buffer, theBuildingInstallation);
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof BuildingInstallationPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final BuildingInstallationPropertyType that = ((BuildingInstallationPropertyType) object);
        {
            BuildingInstallationType lhsBuildingInstallation;
            lhsBuildingInstallation = this.getBuildingInstallation();
            BuildingInstallationType rhsBuildingInstallation;
            rhsBuildingInstallation = that.getBuildingInstallation();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "buildingInstallation", lhsBuildingInstallation), LocatorUtils.property(thatLocator, "buildingInstallation", rhsBuildingInstallation), lhsBuildingInstallation, rhsBuildingInstallation)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            BuildingInstallationType theBuildingInstallation;
            theBuildingInstallation = this.getBuildingInstallation();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "buildingInstallation", theBuildingInstallation), currentHashCode, theBuildingInstallation);
        }
        {
            String theRemoteSchema;
            theRemoteSchema = this.getRemoteSchema();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof BuildingInstallationPropertyType) {
            final BuildingInstallationPropertyType copy = ((BuildingInstallationPropertyType) draftCopy);
            if (this.isSetBuildingInstallation()) {
                BuildingInstallationType sourceBuildingInstallation;
                sourceBuildingInstallation = this.getBuildingInstallation();
                BuildingInstallationType copyBuildingInstallation = ((BuildingInstallationType) strategy.copy(LocatorUtils.property(locator, "buildingInstallation", sourceBuildingInstallation), sourceBuildingInstallation));
                copy.setBuildingInstallation(copyBuildingInstallation);
            } else {
                copy.buildingInstallation = null;
            }
