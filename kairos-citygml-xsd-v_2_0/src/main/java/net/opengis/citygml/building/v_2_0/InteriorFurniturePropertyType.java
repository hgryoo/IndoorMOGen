 ...
 *         &lt;element ref="{http://www.opengis.net/citygml/building/2.0}BuildingFurniture"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "InteriorFurniturePropertyType", propOrder = {
    "buildingFurniture"
})
    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    @XmlElement(name = "BuildingFurniture")
    ...
    /**
     * Gets the value of the buildingFurniture property.
     * 
     * @return
     *     possible object is
     *     {@link BuildingFurnitureType }
     *     
     */
    ...
    /**
     * Sets the value of the buildingFurniture property.
     * 
     * @param value
     *     allowed object is
     *     {@link BuildingFurnitureType }
     *     
     */
    public void setBuildingFurniture(BuildingFurnitureType value) {
        this.buildingFurniture = value;
    }

    public boolean isSetBuildingFurniture() {
        return (this.buildingFurniture!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            BuildingFurnitureType theBuildingFurniture;
            theBuildingFurniture = this.getBuildingFurniture();
            strategy.appendField(locator, this, "buildingFurniture", buffer, theBuildingFurniture);
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof InteriorFurniturePropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final InteriorFurniturePropertyType that = ((InteriorFurniturePropertyType) object);
        {
            BuildingFurnitureType lhsBuildingFurniture;
            lhsBuildingFurniture = this.getBuildingFurniture();
            BuildingFurnitureType rhsBuildingFurniture;
            rhsBuildingFurniture = that.getBuildingFurniture();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "buildingFurniture", lhsBuildingFurniture), LocatorUtils.property(thatLocator, "buildingFurniture", rhsBuildingFurniture), lhsBuildingFurniture, rhsBuildingFurniture)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            BuildingFurnitureType theBuildingFurniture;
            theBuildingFurniture = this.getBuildingFurniture();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "buildingFurniture", theBuildingFurniture), currentHashCode, theBuildingFurniture);
        }
        {
            String theRemoteSchema;
            theRemoteSchema = this.getRemoteSchema();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof InteriorFurniturePropertyType) {
            final InteriorFurniturePropertyType copy = ((InteriorFurniturePropertyType) draftCopy);
            if (this.isSetBuildingFurniture()) {
                BuildingFurnitureType sourceBuildingFurniture;
                sourceBuildingFurniture = this.getBuildingFurniture();
                BuildingFurnitureType copyBuildingFurniture = ((BuildingFurnitureType) strategy.copy(LocatorUtils.property(locator, "buildingFurniture", sourceBuildingFurniture), sourceBuildingFurniture));
                copy.setBuildingFurniture(copyBuildingFurniture);
            } else {
                copy.buildingFurniture = null;
            }
