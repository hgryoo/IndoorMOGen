    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    /**
     * Sets the value of the buildingPart property.
     * 
     * @param value
     *     allowed object is
     *     {@link BuildingPartType }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            BuildingPartType theBuildingPart;
            theBuildingPart = this.getBuildingPart();
            strategy.appendField(locator, this, "buildingPart", buffer, theBuildingPart);
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof BuildingPartPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final BuildingPartPropertyType that = ((BuildingPartPropertyType) object);
        {
            BuildingPartType lhsBuildingPart;
            lhsBuildingPart = this.getBuildingPart();
            BuildingPartType rhsBuildingPart;
            rhsBuildingPart = that.getBuildingPart();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "buildingPart", lhsBuildingPart), LocatorUtils.property(thatLocator, "buildingPart", rhsBuildingPart), lhsBuildingPart, rhsBuildingPart)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            BuildingPartType theBuildingPart;
            theBuildingPart = this.getBuildingPart();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "buildingPart", theBuildingPart), currentHashCode, theBuildingPart);
        }
        {
            String theRemoteSchema;
            theRemoteSchema = this.getRemoteSchema();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof BuildingPartPropertyType) {
            final BuildingPartPropertyType copy = ((BuildingPartPropertyType) draftCopy);
            if (this.isSetBuildingPart()) {
                BuildingPartType sourceBuildingPart;
                sourceBuildingPart = this.getBuildingPart();
                BuildingPartType copyBuildingPart = ((BuildingPartType) strategy.copy(LocatorUtils.property(locator, "buildingPart", sourceBuildingPart), sourceBuildingPart));
                copy.setBuildingPart(copyBuildingPart);
            } else {
                copy.buildingPart = null;
            }
