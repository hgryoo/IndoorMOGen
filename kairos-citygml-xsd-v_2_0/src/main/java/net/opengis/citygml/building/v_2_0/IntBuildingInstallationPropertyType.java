 ...
 *         &lt;element ref="{http://www.opengis.net/citygml/building/2.0}IntBuildingInstallation"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "IntBuildingInstallationPropertyType", propOrder = {
    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    @XmlElement(name = "IntBuildingInstallation")
     ...
     * @return
     *     possible object is
     *     {@link IntBuildingInstallationType }
     *     
     */
     ...
     *     
     */
    public void setIntBuildingInstallation(IntBuildingInstallationType value) {
        this.intBuildingInstallation = value;
    }

    public boolean isSetIntBuildingInstallation() {
        return (this.intBuildingInstallation!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            IntBuildingInstallationType theIntBuildingInstallation;
            theIntBuildingInstallation = this.getIntBuildingInstallation();
            strategy.appendField(locator, this, "intBuildingInstallation", buffer, theIntBuildingInstallation);
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof IntBuildingInstallationPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final IntBuildingInstallationPropertyType that = ((IntBuildingInstallationPropertyType) object);
        {
            IntBuildingInstallationType lhsIntBuildingInstallation;
            lhsIntBuildingInstallation = this.getIntBuildingInstallation();
            IntBuildingInstallationType rhsIntBuildingInstallation;
            rhsIntBuildingInstallation = that.getIntBuildingInstallation();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "intBuildingInstallation", lhsIntBuildingInstallation), LocatorUtils.property(thatLocator, "intBuildingInstallation", rhsIntBuildingInstallation), lhsIntBuildingInstallation, rhsIntBuildingInstallation)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            IntBuildingInstallationType theIntBuildingInstallation;
            theIntBuildingInstallation = this.getIntBuildingInstallation();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "intBuildingInstallation", theIntBuildingInstallation), currentHashCode, theIntBuildingInstallation);
        }
        {
            String theRemoteSchema;
            theRemoteSchema = this.getRemoteSchema();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof IntBuildingInstallationPropertyType) {
            final IntBuildingInstallationPropertyType copy = ((IntBuildingInstallationPropertyType) draftCopy);
            if (this.isSetIntBuildingInstallation()) {
                IntBuildingInstallationType sourceIntBuildingInstallation;
                sourceIntBuildingInstallation = this.getIntBuildingInstallation();
                IntBuildingInstallationType copyIntBuildingInstallation = ((IntBuildingInstallationType) strategy.copy(LocatorUtils.property(locator, "intBuildingInstallation", sourceIntBuildingInstallation), sourceIntBuildingInstallation));
                copy.setIntBuildingInstallation(copyIntBuildingInstallation);
            } else {
                copy.intBuildingInstallation = null;
            }
