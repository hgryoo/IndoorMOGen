 ...
 * generated in the net.opengis.citygml.v_2_0 package. 
...
public class ObjectFactory {
    ...
    private final static QName _GenericApplicationPropertyOfCityObject_QNAME = new QName("http://www.opengis.net/citygml/2.0", "_GenericApplicationPropertyOfCityObject");
    private final static QName _CityModel_QNAME = new QName("http://www.opengis.net/citygml/2.0", "CityModel");
    private final static QName _GenericApplicationPropertyOfCityModel_QNAME = new QName("http://www.opengis.net/citygml/2.0", "_GenericApplicationPropertyOfCityModel");
    private final static QName _CityObjectMember_QNAME = new QName("http://www.opengis.net/citygml/2.0", "cityObjectMember");
    private final static QName _CityObject_QNAME = new QName("http://www.opengis.net/citygml/2.0", "_CityObject");
    private final static QName _Site_QNAME = new QName("http://www.opengis.net/citygml/2.0", "_Site");
    private final static QName _GenericApplicationPropertyOfSite_QNAME = new QName("http://www.opengis.net/citygml/2.0", "_GenericApplicationPropertyOfSite");
    private final static QName _Address_QNAME = new QName("http://www.opengis.net/citygml/2.0", "Address");
    private final static QName _GenericApplicationPropertyOfAddress_QNAME = new QName("http://www.opengis.net/citygml/2.0", "_GenericApplicationPropertyOfAddress");
    private final static QName _ImplicitGeometry_QNAME = new QName("http://www.opengis.net/citygml/2.0", "ImplicitGeometry");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: net.opengis.citygml.v_2_0
     * 
     */
