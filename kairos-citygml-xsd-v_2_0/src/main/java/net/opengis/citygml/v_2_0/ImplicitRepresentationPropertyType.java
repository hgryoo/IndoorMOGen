 ...
 *         &lt;element ref="{http://www.opengis.net/citygml/2.0}ImplicitGeometry"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "ImplicitRepresentationPropertyType", propOrder = {
    "implicitGeometry"
})
    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    @XmlElement(name = "ImplicitGeometry")
     ...
     *     
     */
    public void setImplicitGeometry(ImplicitGeometryType value) {
        this.implicitGeometry = value;
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ImplicitGeometryType theImplicitGeometry;
            theImplicitGeometry = this.getImplicitGeometry();
            strategy.appendField(locator, this, "implicitGeometry", buffer, theImplicitGeometry);
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ImplicitRepresentationPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ImplicitRepresentationPropertyType that = ((ImplicitRepresentationPropertyType) object);
        {
            ImplicitGeometryType lhsImplicitGeometry;
            lhsImplicitGeometry = this.getImplicitGeometry();
            ImplicitGeometryType rhsImplicitGeometry;
            rhsImplicitGeometry = that.getImplicitGeometry();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "implicitGeometry", lhsImplicitGeometry), LocatorUtils.property(thatLocator, "implicitGeometry", rhsImplicitGeometry), lhsImplicitGeometry, rhsImplicitGeometry)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            ImplicitGeometryType theImplicitGeometry;
            theImplicitGeometry = this.getImplicitGeometry();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "implicitGeometry", theImplicitGeometry), currentHashCode, theImplicitGeometry);
        }
        {
            String theRemoteSchema;
            theRemoteSchema = this.getRemoteSchema();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof ImplicitRepresentationPropertyType) {
            final ImplicitRepresentationPropertyType copy = ((ImplicitRepresentationPropertyType) draftCopy);
            if (this.isSetImplicitGeometry()) {
                ImplicitGeometryType sourceImplicitGeometry;
                sourceImplicitGeometry = this.getImplicitGeometry();
                ImplicitGeometryType copyImplicitGeometry = ((ImplicitGeometryType) strategy.copy(LocatorUtils.property(locator, "implicitGeometry", sourceImplicitGeometry), sourceImplicitGeometry));
                copy.setImplicitGeometry(copyImplicitGeometry);
            } else {
                copy.implicitGeometry = null;
            }
