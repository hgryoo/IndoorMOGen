 ...
 *         &lt;element ref="{http://www.opengis.net/citygml/2.0}Address"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "AddressPropertyType", propOrder = {
    "address"
})
    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof AddressPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final AddressPropertyType that = ((AddressPropertyType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof AddressPropertyType) {
            final AddressPropertyType copy = ((AddressPropertyType) draftCopy);
