    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            AddressDetails theAddressDetails;
            theAddressDetails = this.getAddressDetails();
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof XalAddressPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final XalAddressPropertyType that = ((XalAddressPropertyType) object);
        {
            AddressDetails lhsAddressDetails;
            lhsAddressDetails = this.getAddressDetails();
            AddressDetails rhsAddressDetails;
            rhsAddressDetails = that.getAddressDetails();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof XalAddressPropertyType) {
            final XalAddressPropertyType copy = ((XalAddressPropertyType) draftCopy);
            if (this.isSetAddressDetails()) {
                AddressDetails sourceAddressDetails;
                sourceAddressDetails = this.getAddressDetails();
                AddressDetails copyAddressDetails = ((AddressDetails) strategy.copy(LocatorUtils.property(locator, "addressDetails", sourceAddressDetails), sourceAddressDetails));
                copy.setAddressDetails(copyAddressDetails);
            } else {
                copy.addressDetails = null;
            }
        }
        return draftCopy;
    }
