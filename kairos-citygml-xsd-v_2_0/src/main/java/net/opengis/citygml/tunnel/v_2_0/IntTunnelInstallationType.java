 ...
 * 
 * <p>Java class for IntTunnelInstallationType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    @XmlElement(name = "_GenericApplicationPropertyOfIntTunnelInstallation")
    protected List<Object> genericApplicationPropertyOfIntTunnelInstallation;
     ...
     * For example, to add a new item, do as follows:
     * <pre>
     *    getGenericApplicationPropertyOfIntTunnelInstallation().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getGenericApplicationPropertyOfIntTunnelInstallation() {
        if (genericApplicationPropertyOfIntTunnelInstallation == null) {
            genericApplicationPropertyOfIntTunnelInstallation = new ArrayList<Object>();
        }
        return this.genericApplicationPropertyOfIntTunnelInstallation;
    }

    public boolean isSetGenericApplicationPropertyOfIntTunnelInstallation() {
        return ((this.genericApplicationPropertyOfIntTunnelInstallation!= null)&&(!this.genericApplicationPropertyOfIntTunnelInstallation.isEmpty()));
    }

    public void unsetGenericApplicationPropertyOfIntTunnelInstallation() {
        this.genericApplicationPropertyOfIntTunnelInstallation = null;
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            List<Object> theGenericApplicationPropertyOfIntTunnelInstallation;
            theGenericApplicationPropertyOfIntTunnelInstallation = (this.isSetGenericApplicationPropertyOfIntTunnelInstallation()?this.getGenericApplicationPropertyOfIntTunnelInstallation():null);
            strategy.appendField(locator, this, "genericApplicationPropertyOfIntTunnelInstallation", buffer, theGenericApplicationPropertyOfIntTunnelInstallation);
        }
        return buffer;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof IntTunnelInstallationType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final IntTunnelInstallationType that = ((IntTunnelInstallationType) object);
        {
            CodeType lhsClazz;
        ...
        {
            List<Object> lhsGenericApplicationPropertyOfIntTunnelInstallation;
            lhsGenericApplicationPropertyOfIntTunnelInstallation = (this.isSetGenericApplicationPropertyOfIntTunnelInstallation()?this.getGenericApplicationPropertyOfIntTunnelInstallation():null);
            List<Object> rhsGenericApplicationPropertyOfIntTunnelInstallation;
            rhsGenericApplicationPropertyOfIntTunnelInstallation = (that.isSetGenericApplicationPropertyOfIntTunnelInstallation()?that.getGenericApplicationPropertyOfIntTunnelInstallation():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "genericApplicationPropertyOfIntTunnelInstallation", lhsGenericApplicationPropertyOfIntTunnelInstallation), LocatorUtils.property(thatLocator, "genericApplicationPropertyOfIntTunnelInstallation", rhsGenericApplicationPropertyOfIntTunnelInstallation), lhsGenericApplicationPropertyOfIntTunnelInstallation, rhsGenericApplicationPropertyOfIntTunnelInstallation)) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            List<Object> theGenericApplicationPropertyOfIntTunnelInstallation;
            theGenericApplicationPropertyOfIntTunnelInstallation = (this.isSetGenericApplicationPropertyOfIntTunnelInstallation()?this.getGenericApplicationPropertyOfIntTunnelInstallation():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "genericApplicationPropertyOfIntTunnelInstallation", theGenericApplicationPropertyOfIntTunnelInstallation), currentHashCode, theGenericApplicationPropertyOfIntTunnelInstallation);
        }
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof IntTunnelInstallationType) {
            final IntTunnelInstallationType copy = ((IntTunnelInstallationType) draftCopy);
            if (this.isSetClazz()) {
            ...
            if (this.isSetGenericApplicationPropertyOfIntTunnelInstallation()) {
                List<Object> sourceGenericApplicationPropertyOfIntTunnelInstallation;
                sourceGenericApplicationPropertyOfIntTunnelInstallation = (this.isSetGenericApplicationPropertyOfIntTunnelInstallation()?this.getGenericApplicationPropertyOfIntTunnelInstallation():null);
                @SuppressWarnings("unchecked")
                List<Object> copyGenericApplicationPropertyOfIntTunnelInstallation = ((List<Object> ) strategy.copy(LocatorUtils.property(locator, "genericApplicationPropertyOfIntTunnelInstallation", sourceGenericApplicationPropertyOfIntTunnelInstallation), sourceGenericApplicationPropertyOfIntTunnelInstallation));
                copy.unsetGenericApplicationPropertyOfIntTunnelInstallation();
                if (copyGenericApplicationPropertyOfIntTunnelInstallation!= null) {
                    List<Object> uniqueGenericApplicationPropertyOfIntTunnelInstallationl = copy.getGenericApplicationPropertyOfIntTunnelInstallation();
                    uniqueGenericApplicationPropertyOfIntTunnelInstallationl.addAll(copyGenericApplicationPropertyOfIntTunnelInstallation);
                }
            } else {
                copy.unsetGenericApplicationPropertyOfIntTunnelInstallation();
            }
