 ...
 * 				none. 
 * 
 * <p>Java class for InteriorHollowSpacePropertyType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="InteriorHollowSpacePropertyType"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence minOccurs="0"&gt;
 *         &lt;element ref="{http://www.opengis.net/citygml/tunnel/2.0}HollowSpace"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "InteriorHollowSpacePropertyType", propOrder = {
    "hollowSpace"
})
public class InteriorHollowSpacePropertyType
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{

    @XmlElement(name = "HollowSpace")
    protected HollowSpaceType hollowSpace;
    ...
    /**
     * Gets the value of the hollowSpace property.
     * 
     * @return
     *     possible object is
     *     {@link HollowSpaceType }
     *     
     */
    public HollowSpaceType getHollowSpace() {
        return hollowSpace;
    }

    /**
     * Sets the value of the hollowSpace property.
     * 
     * @param value
     *     allowed object is
     *     {@link HollowSpaceType }
     *     
     */
    public void setHollowSpace(HollowSpaceType value) {
        this.hollowSpace = value;
    }

    public boolean isSetHollowSpace() {
        return (this.hollowSpace!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            HollowSpaceType theHollowSpace;
            theHollowSpace = this.getHollowSpace();
            strategy.appendField(locator, this, "hollowSpace", buffer, theHollowSpace);
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof InteriorHollowSpacePropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final InteriorHollowSpacePropertyType that = ((InteriorHollowSpacePropertyType) object);
        {
            HollowSpaceType lhsHollowSpace;
            lhsHollowSpace = this.getHollowSpace();
            HollowSpaceType rhsHollowSpace;
            rhsHollowSpace = that.getHollowSpace();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "hollowSpace", lhsHollowSpace), LocatorUtils.property(thatLocator, "hollowSpace", rhsHollowSpace), lhsHollowSpace, rhsHollowSpace)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            HollowSpaceType theHollowSpace;
            theHollowSpace = this.getHollowSpace();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "hollowSpace", theHollowSpace), currentHashCode, theHollowSpace);
        }
        {
            String theRemoteSchema;
            theRemoteSchema = this.getRemoteSchema();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof InteriorHollowSpacePropertyType) {
            final InteriorHollowSpacePropertyType copy = ((InteriorHollowSpacePropertyType) draftCopy);
            if (this.isSetHollowSpace()) {
                HollowSpaceType sourceHollowSpace;
                sourceHollowSpace = this.getHollowSpace();
                HollowSpaceType copyHollowSpace = ((HollowSpaceType) strategy.copy(LocatorUtils.property(locator, "hollowSpace", sourceHollowSpace), sourceHollowSpace));
                copy.setHollowSpace(copyHollowSpace);
            } else {
                copy.hollowSpace = null;
            }
