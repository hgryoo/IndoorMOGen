 ...
 *         &lt;element ref="{http://www.opengis.net/citygml/tunnel/2.0}TunnelFurniture"/&gt;
 *       &lt;/sequence&gt;
    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    @XmlElement(name = "TunnelFurniture")
    protected TunnelFurnitureType tunnelFurniture;
     ...
     * @return
     *     possible object is
     *     {@link TunnelFurnitureType }
     *     
     */
    public TunnelFurnitureType getTunnelFurniture() {
     ...
     *     
     */
    public void setTunnelFurniture(TunnelFurnitureType value) {
        this.tunnelFurniture = value;
    }

    public boolean isSetTunnelFurniture() {
        return (this.tunnelFurniture!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            TunnelFurnitureType theTunnelFurniture;
            theTunnelFurniture = this.getTunnelFurniture();
            strategy.appendField(locator, this, "tunnelFurniture", buffer, theTunnelFurniture);
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            TunnelFurnitureType lhsTunnelFurniture;
            lhsTunnelFurniture = this.getTunnelFurniture();
            TunnelFurnitureType rhsTunnelFurniture;
            rhsTunnelFurniture = that.getTunnelFurniture();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "tunnelFurniture", lhsTunnelFurniture), LocatorUtils.property(thatLocator, "tunnelFurniture", rhsTunnelFurniture), lhsTunnelFurniture, rhsTunnelFurniture)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            TunnelFurnitureType theTunnelFurniture;
            theTunnelFurniture = this.getTunnelFurniture();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "tunnelFurniture", theTunnelFurniture), currentHashCode, theTunnelFurniture);
        }
        {
            String theRemoteSchema;
            theRemoteSchema = this.getRemoteSchema();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof InteriorFurniturePropertyType) {
            ...
            if (this.isSetTunnelFurniture()) {
                TunnelFurnitureType sourceTunnelFurniture;
                sourceTunnelFurniture = this.getTunnelFurniture();
                TunnelFurnitureType copyTunnelFurniture = ((TunnelFurnitureType) strategy.copy(LocatorUtils.property(locator, "tunnelFurniture", sourceTunnelFurniture), sourceTunnelFurniture));
                copy.setTunnelFurniture(copyTunnelFurniture);
            } else {
                copy.tunnelFurniture = null;
            }
