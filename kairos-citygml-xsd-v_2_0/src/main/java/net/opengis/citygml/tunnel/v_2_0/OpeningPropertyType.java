 ...
 *         &lt;element ref="{http://www.opengis.net/citygml/tunnel/2.0}_Opening"/&gt;
 *       &lt;/sequence&gt;
    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    @XmlElementRef(name = "_Opening", namespace = "http://www.opengis.net/citygml/tunnel/2.0", type = JAXBElement.class, required = false)
    protected JAXBElement<? extends AbstractOpeningType> opening;
     ...
     *     
     */
    public JAXBElement<? extends AbstractOpeningType> getOpening() {
        return opening;
    }
     ...
     *     
     */
    public void setOpening(JAXBElement<? extends AbstractOpeningType> value) {
        this.opening = value;
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractOpeningType> theOpening;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof OpeningPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final OpeningPropertyType that = ((OpeningPropertyType) object);
        {
            JAXBElement<? extends AbstractOpeningType> lhsOpening;
            lhsOpening = this.getOpening();
            JAXBElement<? extends AbstractOpeningType> rhsOpening;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof OpeningPropertyType) {
            final OpeningPropertyType copy = ((OpeningPropertyType) draftCopy);
            if (this.isSetOpening()) {
                JAXBElement<? extends AbstractOpeningType> sourceOpening;
                sourceOpening = this.getOpening();
                @SuppressWarnings("unchecked")
                JAXBElement<? extends AbstractOpeningType> copyOpening = ((JAXBElement<? extends AbstractOpeningType> ) strategy.copy(LocatorUtils.property(locator, "opening", sourceOpening), sourceOpening));
