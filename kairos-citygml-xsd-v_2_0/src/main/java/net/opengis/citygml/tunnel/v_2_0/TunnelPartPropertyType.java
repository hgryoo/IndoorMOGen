    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    /**
     * Gets the value of the tunnelPart property.
     * 
     * @return
     *     possible object is
     *     {@link TunnelPartType }
    ...
    /**
     * Sets the value of the tunnelPart property.
     * 
     * @param value
     *     allowed object is
     *     {@link TunnelPartType }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            TunnelPartType theTunnelPart;
            theTunnelPart = this.getTunnelPart();
            strategy.appendField(locator, this, "tunnelPart", buffer, theTunnelPart);
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof TunnelPartPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final TunnelPartPropertyType that = ((TunnelPartPropertyType) object);
        {
            TunnelPartType lhsTunnelPart;
            lhsTunnelPart = this.getTunnelPart();
            TunnelPartType rhsTunnelPart;
            rhsTunnelPart = that.getTunnelPart();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "tunnelPart", lhsTunnelPart), LocatorUtils.property(thatLocator, "tunnelPart", rhsTunnelPart), lhsTunnelPart, rhsTunnelPart)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            TunnelPartType theTunnelPart;
            theTunnelPart = this.getTunnelPart();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "tunnelPart", theTunnelPart), currentHashCode, theTunnelPart);
        }
        {
            String theRemoteSchema;
            theRemoteSchema = this.getRemoteSchema();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof TunnelPartPropertyType) {
            final TunnelPartPropertyType copy = ((TunnelPartPropertyType) draftCopy);
            if (this.isSetTunnelPart()) {
                TunnelPartType sourceTunnelPart;
                sourceTunnelPart = this.getTunnelPart();
                TunnelPartType copyTunnelPart = ((TunnelPartType) strategy.copy(LocatorUtils.property(locator, "tunnelPart", sourceTunnelPart), sourceTunnelPart));
                copy.setTunnelPart(copyTunnelPart);
            } else {
                copy.tunnelPart = null;
            }
