 ...
 * 
 * <p>Java class for IntTunnelInstallationPropertyType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="IntTunnelInstallationPropertyType"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence minOccurs="0"&gt;
 *         &lt;element ref="{http://www.opengis.net/citygml/tunnel/2.0}IntTunnelInstallation"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "IntTunnelInstallationPropertyType", propOrder = {
    "intTunnelInstallation"
})
public class IntTunnelInstallationPropertyType
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{

    @XmlElement(name = "IntTunnelInstallation")
    protected IntTunnelInstallationType intTunnelInstallation;
     ...
     * @return
     *     possible object is
     *     {@link IntTunnelInstallationType }
     *     
     */
    public IntTunnelInstallationType getIntTunnelInstallation() {
     ...
     *     
     */
    public void setIntTunnelInstallation(IntTunnelInstallationType value) {
        this.intTunnelInstallation = value;
    }

    public boolean isSetIntTunnelInstallation() {
        return (this.intTunnelInstallation!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            IntTunnelInstallationType theIntTunnelInstallation;
            theIntTunnelInstallation = this.getIntTunnelInstallation();
            strategy.appendField(locator, this, "intTunnelInstallation", buffer, theIntTunnelInstallation);
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof IntTunnelInstallationPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final IntTunnelInstallationPropertyType that = ((IntTunnelInstallationPropertyType) object);
        {
            IntTunnelInstallationType lhsIntTunnelInstallation;
            lhsIntTunnelInstallation = this.getIntTunnelInstallation();
            IntTunnelInstallationType rhsIntTunnelInstallation;
            rhsIntTunnelInstallation = that.getIntTunnelInstallation();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "intTunnelInstallation", lhsIntTunnelInstallation), LocatorUtils.property(thatLocator, "intTunnelInstallation", rhsIntTunnelInstallation), lhsIntTunnelInstallation, rhsIntTunnelInstallation)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            IntTunnelInstallationType theIntTunnelInstallation;
            theIntTunnelInstallation = this.getIntTunnelInstallation();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "intTunnelInstallation", theIntTunnelInstallation), currentHashCode, theIntTunnelInstallation);
        }
        {
            String theRemoteSchema;
            theRemoteSchema = this.getRemoteSchema();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof IntTunnelInstallationPropertyType) {
            final IntTunnelInstallationPropertyType copy = ((IntTunnelInstallationPropertyType) draftCopy);
            if (this.isSetIntTunnelInstallation()) {
                IntTunnelInstallationType sourceIntTunnelInstallation;
                sourceIntTunnelInstallation = this.getIntTunnelInstallation();
                IntTunnelInstallationType copyIntTunnelInstallation = ((IntTunnelInstallationType) strategy.copy(LocatorUtils.property(locator, "intTunnelInstallation", sourceIntTunnelInstallation), sourceIntTunnelInstallation));
                copy.setIntTunnelInstallation(copyIntTunnelInstallation);
            } else {
                copy.intTunnelInstallation = null;
            }
