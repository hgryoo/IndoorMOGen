 ...
 * 				both nor none. 
 * 
 * <p>Java class for TunnelInstallationPropertyType complex type.
 * 
 ...
 *         &lt;element ref="{http://www.opengis.net/citygml/tunnel/2.0}TunnelInstallation"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "TunnelInstallationPropertyType", propOrder = {
    "tunnelInstallation"
})
public class TunnelInstallationPropertyType
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{

    @XmlElement(name = "TunnelInstallation")
    protected TunnelInstallationType tunnelInstallation;
     ...
     * @return
     *     possible object is
     *     {@link TunnelInstallationType }
     *     
     */
    public TunnelInstallationType getTunnelInstallation() {
     ...
     *     
     */
    public void setTunnelInstallation(TunnelInstallationType value) {
        this.tunnelInstallation = value;
    }

    public boolean isSetTunnelInstallation() {
        return (this.tunnelInstallation!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            TunnelInstallationType theTunnelInstallation;
            theTunnelInstallation = this.getTunnelInstallation();
            strategy.appendField(locator, this, "tunnelInstallation", buffer, theTunnelInstallation);
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof TunnelInstallationPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final TunnelInstallationPropertyType that = ((TunnelInstallationPropertyType) object);
        {
            TunnelInstallationType lhsTunnelInstallation;
            lhsTunnelInstallation = this.getTunnelInstallation();
            TunnelInstallationType rhsTunnelInstallation;
            rhsTunnelInstallation = that.getTunnelInstallation();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "tunnelInstallation", lhsTunnelInstallation), LocatorUtils.property(thatLocator, "tunnelInstallation", rhsTunnelInstallation), lhsTunnelInstallation, rhsTunnelInstallation)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            TunnelInstallationType theTunnelInstallation;
            theTunnelInstallation = this.getTunnelInstallation();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "tunnelInstallation", theTunnelInstallation), currentHashCode, theTunnelInstallation);
        }
        {
            String theRemoteSchema;
            theRemoteSchema = this.getRemoteSchema();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof TunnelInstallationPropertyType) {
            final TunnelInstallationPropertyType copy = ((TunnelInstallationPropertyType) draftCopy);
            if (this.isSetTunnelInstallation()) {
                TunnelInstallationType sourceTunnelInstallation;
                sourceTunnelInstallation = this.getTunnelInstallation();
                TunnelInstallationType copyTunnelInstallation = ((TunnelInstallationType) strategy.copy(LocatorUtils.property(locator, "tunnelInstallation", sourceTunnelInstallation), sourceTunnelInstallation));
                copy.setTunnelInstallation(copyTunnelInstallation);
            } else {
                copy.tunnelInstallation = null;
            }
