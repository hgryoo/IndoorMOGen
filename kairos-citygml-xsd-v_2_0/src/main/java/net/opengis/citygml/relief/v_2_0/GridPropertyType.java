...
import net.opengis.gml.v_3_1_1.RectifiedGridCoverageType;
 ...
 * 				both nor none. 
 * 
 * <p>Java class for gridPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    @XmlElement(name = "RectifiedGridCoverage", namespace = "http://www.opengis.net/gml")
    ...
    /**
     * Gets the value of the rectifiedGridCoverage property.
     * 
     * @return
     *     possible object is
     *     {@link RectifiedGridCoverageType }
     *     
     */
    ...
    /**
     * Sets the value of the rectifiedGridCoverage property.
     * 
     * @param value
     *     allowed object is
     *     {@link RectifiedGridCoverageType }
     *     
     */
    public void setRectifiedGridCoverage(RectifiedGridCoverageType value) {
        this.rectifiedGridCoverage = value;
    }

    public boolean isSetRectifiedGridCoverage() {
        return (this.rectifiedGridCoverage!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            RectifiedGridCoverageType theRectifiedGridCoverage;
            theRectifiedGridCoverage = this.getRectifiedGridCoverage();
            strategy.appendField(locator, this, "rectifiedGridCoverage", buffer, theRectifiedGridCoverage);
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GridPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GridPropertyType that = ((GridPropertyType) object);
        {
            RectifiedGridCoverageType lhsRectifiedGridCoverage;
            lhsRectifiedGridCoverage = this.getRectifiedGridCoverage();
            RectifiedGridCoverageType rhsRectifiedGridCoverage;
            rhsRectifiedGridCoverage = that.getRectifiedGridCoverage();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "rectifiedGridCoverage", lhsRectifiedGridCoverage), LocatorUtils.property(thatLocator, "rectifiedGridCoverage", rhsRectifiedGridCoverage), lhsRectifiedGridCoverage, rhsRectifiedGridCoverage)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            RectifiedGridCoverageType theRectifiedGridCoverage;
            theRectifiedGridCoverage = this.getRectifiedGridCoverage();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "rectifiedGridCoverage", theRectifiedGridCoverage), currentHashCode, theRectifiedGridCoverage);
        }
        {
            String theRemoteSchema;
            theRemoteSchema = this.getRemoteSchema();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof GridPropertyType) {
            final GridPropertyType copy = ((GridPropertyType) draftCopy);
            if (this.isSetRectifiedGridCoverage()) {
                RectifiedGridCoverageType sourceRectifiedGridCoverage;
                sourceRectifiedGridCoverage = this.getRectifiedGridCoverage();
                RectifiedGridCoverageType copyRectifiedGridCoverage = ((RectifiedGridCoverageType) strategy.copy(LocatorUtils.property(locator, "rectifiedGridCoverage", sourceRectifiedGridCoverage), sourceRectifiedGridCoverage));
                copy.setRectifiedGridCoverage(copyRectifiedGridCoverage);
            } else {
                copy.rectifiedGridCoverage = null;
            }
