 ...
 * 				none. 
 * 
 * <p>Java class for tinPropertyType complex type.
 * 
...
@XmlType(name = "tinPropertyType", propOrder = {
    "triangulatedSurface"
})
    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    @XmlElementRef(name = "TriangulatedSurface", namespace = "http://www.opengis.net/gml", type = JAXBElement.class, required = false)
    protected JAXBElement<? extends TriangulatedSurfaceType> triangulatedSurface;
    ...
    /**
     * Gets the value of the triangulatedSurface property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<? extends TriangulatedSurfaceType> getTriangulatedSurface() {
        return triangulatedSurface;
    }

    /**
     * Sets the value of the triangulatedSurface property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link TriangulatedSurfaceType }{@code >}
     ...
     *     
     */
    public void setTriangulatedSurface(JAXBElement<? extends TriangulatedSurfaceType> value) {
        this.triangulatedSurface = value;
    }

    public boolean isSetTriangulatedSurface() {
        return (this.triangulatedSurface!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends TriangulatedSurfaceType> theTriangulatedSurface;
            theTriangulatedSurface = this.getTriangulatedSurface();
            strategy.appendField(locator, this, "triangulatedSurface", buffer, theTriangulatedSurface);
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof TinPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final TinPropertyType that = ((TinPropertyType) object);
        {
            JAXBElement<? extends TriangulatedSurfaceType> lhsTriangulatedSurface;
            lhsTriangulatedSurface = this.getTriangulatedSurface();
            JAXBElement<? extends TriangulatedSurfaceType> rhsTriangulatedSurface;
            rhsTriangulatedSurface = that.getTriangulatedSurface();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "triangulatedSurface", lhsTriangulatedSurface), LocatorUtils.property(thatLocator, "triangulatedSurface", rhsTriangulatedSurface), lhsTriangulatedSurface, rhsTriangulatedSurface)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends TriangulatedSurfaceType> theTriangulatedSurface;
            theTriangulatedSurface = this.getTriangulatedSurface();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "triangulatedSurface", theTriangulatedSurface), currentHashCode, theTriangulatedSurface);
        }
        {
            String theRemoteSchema;
            theRemoteSchema = this.getRemoteSchema();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof TinPropertyType) {
            final TinPropertyType copy = ((TinPropertyType) draftCopy);
            if (this.isSetTriangulatedSurface()) {
                JAXBElement<? extends TriangulatedSurfaceType> sourceTriangulatedSurface;
                sourceTriangulatedSurface = this.getTriangulatedSurface();
                @SuppressWarnings("unchecked")
                JAXBElement<? extends TriangulatedSurfaceType> copyTriangulatedSurface = ((JAXBElement<? extends TriangulatedSurfaceType> ) strategy.copy(LocatorUtils.property(locator, "triangulatedSurface", sourceTriangulatedSurface), sourceTriangulatedSurface));
                copy.setTriangulatedSurface(copyTriangulatedSurface);
            } else {
                copy.triangulatedSurface = null;
            }
