...
public class SurfaceDataPropertyType
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{

    @XmlElementRef(name = "_SurfaceData", namespace = "http://www.opengis.net/citygml/appearance/2.0", type = JAXBElement.class, required = false)
    protected JAXBElement<? extends AbstractSurfaceDataType> surfaceData;
    ...
    public void setSurfaceData(JAXBElement<? extends AbstractSurfaceDataType> value) {
        this.surfaceData = value;
    }

    public boolean isSetSurfaceData() {
        return (this.surfaceData!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractSurfaceDataType> theSurfaceData;
            theSurfaceData = this.getSurfaceData();
            strategy.appendField(locator, this, "surfaceData", buffer, theSurfaceData);
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof SurfaceDataPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final SurfaceDataPropertyType that = ((SurfaceDataPropertyType) object);
        {
            JAXBElement<? extends AbstractSurfaceDataType> lhsSurfaceData;
            lhsSurfaceData = this.getSurfaceData();
            JAXBElement<? extends AbstractSurfaceDataType> rhsSurfaceData;
            rhsSurfaceData = that.getSurfaceData();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "surfaceData", lhsSurfaceData), LocatorUtils.property(thatLocator, "surfaceData", rhsSurfaceData), lhsSurfaceData, rhsSurfaceData)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractSurfaceDataType> theSurfaceData;
            theSurfaceData = this.getSurfaceData();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "surfaceData", theSurfaceData), currentHashCode, theSurfaceData);
        }
        {
            String theRemoteSchema;
            theRemoteSchema = this.getRemoteSchema();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof SurfaceDataPropertyType) {
            final SurfaceDataPropertyType copy = ((SurfaceDataPropertyType) draftCopy);
            if (this.isSetSurfaceData()) {
                JAXBElement<? extends AbstractSurfaceDataType> sourceSurfaceData;
                sourceSurfaceData = this.getSurfaceData();
                @SuppressWarnings("unchecked")
                JAXBElement<? extends AbstractSurfaceDataType> copySurfaceData = ((JAXBElement<? extends AbstractSurfaceDataType> ) strategy.copy(LocatorUtils.property(locator, "surfaceData", sourceSurfaceData), sourceSurfaceData));
                copy.setSurfaceData(copySurfaceData);
            } else {
                copy.surfaceData = null;
            }
