 ...
 *         &lt;element ref="{http://www.opengis.net/citygml/appearance/2.0}_TextureParameterization"/&gt;
 *       &lt;/sequence&gt;
    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    protected JAXBElement<? extends AbstractTextureParameterizationType> textureParameterization;
    ...
    public void setTextureParameterization(JAXBElement<? extends AbstractTextureParameterizationType> value) {
        this.textureParameterization = value;
    }

    public boolean isSetTextureParameterization() {
        return (this.textureParameterization!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractTextureParameterizationType> theTextureParameterization;
            theTextureParameterization = this.getTextureParameterization();
            strategy.appendField(locator, this, "textureParameterization", buffer, theTextureParameterization);
        }
        {
            String theUri;
            theUri = this.getUri();
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof TextureAssociationType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final TextureAssociationType that = ((TextureAssociationType) object);
        {
            JAXBElement<? extends AbstractTextureParameterizationType> lhsTextureParameterization;
            lhsTextureParameterization = this.getTextureParameterization();
            JAXBElement<? extends AbstractTextureParameterizationType> rhsTextureParameterization;
            rhsTextureParameterization = that.getTextureParameterization();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "textureParameterization", lhsTextureParameterization), LocatorUtils.property(thatLocator, "textureParameterization", rhsTextureParameterization), lhsTextureParameterization, rhsTextureParameterization)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractTextureParameterizationType> theTextureParameterization;
            theTextureParameterization = this.getTextureParameterization();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "textureParameterization", theTextureParameterization), currentHashCode, theTextureParameterization);
        }
        {
            String theUri;
            theUri = this.getUri();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof TextureAssociationType) {
            final TextureAssociationType copy = ((TextureAssociationType) draftCopy);
            if (this.isSetTextureParameterization()) {
                JAXBElement<? extends AbstractTextureParameterizationType> sourceTextureParameterization;
                sourceTextureParameterization = this.getTextureParameterization();
                @SuppressWarnings("unchecked")
                JAXBElement<? extends AbstractTextureParameterizationType> copyTextureParameterization = ((JAXBElement<? extends AbstractTextureParameterizationType> ) strategy.copy(LocatorUtils.property(locator, "textureParameterization", sourceTextureParameterization), sourceTextureParameterization));
                copy.setTextureParameterization(copyTextureParameterization);
            } else {
                copy.textureParameterization = null;
            }
            if (this.isSetUri()) {
                String sourceUri;
