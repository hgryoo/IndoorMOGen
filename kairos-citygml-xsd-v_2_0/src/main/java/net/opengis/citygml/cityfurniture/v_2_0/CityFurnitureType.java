 ...
 *         &lt;element ref="{http://www.opengis.net/citygml/cityfurniture/2.0}_GenericApplicationPropertyOfCityFurniture" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class CityFurnitureType
    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean isSetGenericApplicationPropertyOfCityFurniture() {
        return ((this.genericApplicationPropertyOfCityFurniture!= null)&&(!this.genericApplicationPropertyOfCityFurniture.isEmpty()));
    }

    public void unsetGenericApplicationPropertyOfCityFurniture() {
        this.genericApplicationPropertyOfCityFurniture = null;
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            List<Object> theGenericApplicationPropertyOfCityFurniture;
            theGenericApplicationPropertyOfCityFurniture = (this.isSetGenericApplicationPropertyOfCityFurniture()?this.getGenericApplicationPropertyOfCityFurniture():null);
            strategy.appendField(locator, this, "genericApplicationPropertyOfCityFurniture", buffer, theGenericApplicationPropertyOfCityFurniture);
        }
        return buffer;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CityFurnitureType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final CityFurnitureType that = ((CityFurnitureType) object);
        {
            CodeType lhsClazz;
        ...
        {
            List<Object> lhsGenericApplicationPropertyOfCityFurniture;
            lhsGenericApplicationPropertyOfCityFurniture = (this.isSetGenericApplicationPropertyOfCityFurniture()?this.getGenericApplicationPropertyOfCityFurniture():null);
            List<Object> rhsGenericApplicationPropertyOfCityFurniture;
            rhsGenericApplicationPropertyOfCityFurniture = (that.isSetGenericApplicationPropertyOfCityFurniture()?that.getGenericApplicationPropertyOfCityFurniture():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "genericApplicationPropertyOfCityFurniture", lhsGenericApplicationPropertyOfCityFurniture), LocatorUtils.property(thatLocator, "genericApplicationPropertyOfCityFurniture", rhsGenericApplicationPropertyOfCityFurniture), lhsGenericApplicationPropertyOfCityFurniture, rhsGenericApplicationPropertyOfCityFurniture)) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            List<Object> theGenericApplicationPropertyOfCityFurniture;
            theGenericApplicationPropertyOfCityFurniture = (this.isSetGenericApplicationPropertyOfCityFurniture()?this.getGenericApplicationPropertyOfCityFurniture():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "genericApplicationPropertyOfCityFurniture", theGenericApplicationPropertyOfCityFurniture), currentHashCode, theGenericApplicationPropertyOfCityFurniture);
        }
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof CityFurnitureType) {
            final CityFurnitureType copy = ((CityFurnitureType) draftCopy);
            if (this.isSetClazz()) {
            ...
            if (this.isSetGenericApplicationPropertyOfCityFurniture()) {
                List<Object> sourceGenericApplicationPropertyOfCityFurniture;
                sourceGenericApplicationPropertyOfCityFurniture = (this.isSetGenericApplicationPropertyOfCityFurniture()?this.getGenericApplicationPropertyOfCityFurniture():null);
                @SuppressWarnings("unchecked")
                List<Object> copyGenericApplicationPropertyOfCityFurniture = ((List<Object> ) strategy.copy(LocatorUtils.property(locator, "genericApplicationPropertyOfCityFurniture", sourceGenericApplicationPropertyOfCityFurniture), sourceGenericApplicationPropertyOfCityFurniture));
                copy.unsetGenericApplicationPropertyOfCityFurniture();
                if (copyGenericApplicationPropertyOfCityFurniture!= null) {
                    List<Object> uniqueGenericApplicationPropertyOfCityFurniturel = copy.getGenericApplicationPropertyOfCityFurniture();
                    uniqueGenericApplicationPropertyOfCityFurniturel.addAll(copyGenericApplicationPropertyOfCityFurniture);
                }
            } else {
                copy.unsetGenericApplicationPropertyOfCityFurniture();
            }
